...
and the [MindPoint group](https://github.com/MindPointGroup/RHEL7-CIS)


Requirements
------------

You should **very carefully** read through the tasks to make sure these changes will not break your systems before running this playbook.

Role Variables
--------------
There are many role variables defined in defaults/main.yml. This list shows the most important. Every point also has a variable with the default set to on,
override these with a vars file, or group vars for finer grained control.
...
##### 5.3.2 | PATCH | Ensure lockout for failed password attempts is configured
```
...
security_pam_faillock_unlock_time: 3600  # period of time to lock the account for
```
